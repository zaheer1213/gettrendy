    ...
    <>
      <div className="privacy-policy-container">
        <div className="privacy-policy-content">
          ...
          <p>
            Users placing scheduled orders may choose to cancel their Orders
            free of charge, provided the cancellation is made a minimum of "2
            hours" before the scheduled slot start time. Cancellation requests
            received after this specified time window will result in a
            cancellation fee of upto 100% (one hundred percent) of the order
            value.
          </p>
          <p>
            Users placing express orders may choose to cancel their Orders free
            of charge within "5 minutes" after the order placement. Any
            cancellation requests made after this specified time window will
            result in a cancellation fee of upto 100% (one hundred percent) of
            the order value.
          </p>
          <p>
          ...
          <ul>
            <li>
              In the event if the address provided by the User is either wrong
              or falls outside the delivery zone;
            </li>
            <li>
              Failure to contact User by phone at the time of delivering the
              Order booking;
            </li>
            <li>
              Failure to deliver Order due to lack of information, direction or
              authorization from User at the time of delivery
            </li>
          </ul>
          <p>
          ...
          <p>
            Users placing scheduled orders have the option to reschedule their
          ...
          <p>
            icious reserves the right to change/amend/add/delete/modify this
            Policy in whole or in part, at any time without assigning any reason
            whatsoever. The User acknowledges that they will not be personally
            advised of any such change/amendment/addition/deletion/modification.
            The User is advised to check for any such
            change/amendment/addition/deletion/modification regularly. The User
            hereby unconditionally agrees to all such
...
export default CancellationReschedule;
